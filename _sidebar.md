<!-- _sidebar.md — navegação do Docsify -->
...
- **Fundamentos de IA Generativa**
  ...
  - [Módulo 2 — IA e LLM](docs/fundamentos-ia-generativa/2-ia-e-llm.md)
...
- **Prompt Engineering**
  - [Módulo 1 — Introdução](docs/prompt-engineering/1-introducao.md)
...
- **Design Docs com IA**
  ...
  - [Módulo 4 — Architecture Decision Record (ADR)](docs/design-docs/4-architecture-decision-record.md)
  - Templates — PRD
  ...
  - Templates — Design e Arquitetura
    ...
    - [Prompt para Deep Research — Fase 2](docs/design-docs/templates-design-arquitetura/ex_prompt_deep_research_fase2.md)

- **Referências**
  - [Atalhos do GitHub Copilot no VS Code](docs/referencias/atalhos-vscode-copilot.md)

- **Acompanhamento**
  - [Cronograma de estudos](cronograma-estudos.md)
